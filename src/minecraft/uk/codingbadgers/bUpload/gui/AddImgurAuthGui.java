...
public class AddImgurAuthGui extends AddAuthGui {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		drawCenteredString(fontRenderer, I18n.getString("image.imgur.login.ln1"), this.width / 2, this.height / 6 + 30, 0xFFFFFF);
		drawCenteredString(fontRenderer, I18n.getString("image.imgur.login.ln2"), this.width / 2, this.height / 6 + 40, 0xFFFFFF);
		pinCode.drawTextBox();
